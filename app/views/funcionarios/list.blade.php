 ...
 @section('conteudo')
    ...
    <div class="container col-md-12">
	    ...
	    <div class="row">
	        <div class="panel panel-primary filterable">
	            <div class="panel-heading">
	                ...
	                <div class="pull-right">
	                	<a href="{{ URL::route('funcionario_add') }}" class="btn btn-success btn-xs add-more" type="button"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
	        ...
	        {{ '<span class="badge pull-right">Registros '.$qtd.'</span>' .$funcionarios->links()  }}
	    </div>
	</div>
