 ...
 @section('conteudo')
    ...
    <div class="container col-md-12">
	    ...
	    <div class="row">
	        <div class="panel panel-primary filterable">
	            <div class="panel-heading">
	                ...
	                <div class="pull-right">
	                	<a href="{{ URL::to('recibo/create') }}" class="btn btn-success btn-xs add-more" type="button"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
	            ...
	            <table class="table" id="mytable" >
	                <thead>
	                    <tr class="filters">
	                        ...
	                        <th><input type="text" class="form-control" placeholder="Convênio" disabled></th>
	                ...
	                <tbody>
								...
								<tr>
									...
									<td colspan="2">
										...
										<!-- editar <a class="btn btn-primary btn-xs" href="{{ URL::to('recibo/' . $recibo->id . '/edit') }}"><i class="glyphicon glyphicon-pencil"></i></a> -->


	                        			{{ Form::open(array('url' => 'recibo/' . $recibo->id, 'class' => 'pull-right')) }}
	        ...
	        {{ '<span class="badge pull-right">Registros '.$qtd.'</span>' .$recibos->links()  }}
	    </div>
	</div>
